...
Rscript -e "rmarkdown::render('systemPipePolyRIBOseq.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('systemPipePolyRIBOseq.Rmd', tangle=TRUE)"; Rscript -e "rmarkdown::render('systemPipePolyRIBOseq.Rmd', c('BiocStyle::pdf_document'))"
-->
